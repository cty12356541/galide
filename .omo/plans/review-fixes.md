...
- Evidence: .omo/evidence/task-<N>-review-fixes.<ext>
...
- [ ] F1: Plan compliance audit — every todo has refs + acceptance + QA + commit
- [ ] F2: Code quality review — typecheck, lint, test all pass
- [ ] F3: Real manual QA — run the app, verify key flows
- [ ] F4: Scope fidelity — no out-of-scope changes, no regressions
